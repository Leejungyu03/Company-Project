...
function track(target, type, key) {
  if (shouldTrack && activeEffect) {
    ...
    const eventInfo = "development" !== 'production' ? {
      effect: activeEffect,
      target,
      type,
      key
...
function emit$1(instance, event, ...rawArgs) {
  ...
  props[handlerName = (0, _shared.toHandlerKey)((0, _shared.camelize)(event))]; // for v-model update:xxx events, also trigger kebab-case equivalent
...
function watchPostEffect(effect, options) {
  return doWatch(effect, null, "development" !== 'production' ? Object.assign(options || {}, {
    flush: 'post'
  }) : {
    flush: 'post'
  });
...
function traverse(value, seen) {
  if (!(0, _shared.isObject)(value) || value["__v_skip"
  /* SKIP */
  ]) {
    return value;
  }
...
const initSlots = (instance, children) => {
  ...
  /* SLOTS_CHILDREN */
    ...
    if (type) {
      ...
      instance.slots = (0, _reactivity.toRaw)(children); // make compiler marker non-enumerable
  ...
  /* SLOTS_CHILDREN */
    ...
    if (type) {
      ...
      /* STABLE */
        ...
        // normalization.
        (0, _shared.extend)(slots, children); // #2893
...
function createHydrationFunctions(rendererInternals) {
  ...
  const hydrateElement = (el, vnode, parentComponent, parentSuspense, slotScopeIds, optimized) => {
    ...
    if ("development" !== 'production' || forcePatchValue || patchFlag !== -1
    /* HOISTED */
    ) {
      if (dirs) {
...
function baseCreateRenderer(options, createHydrationFns) {
  ...
  const setupRenderEffect = (instance, initialVNode, container, anchor, parentSuspense, isSVG, optimized) => {
    ...
    const effect = instance.effect = new _reactivity.ReactiveEffect(componentUpdateFn, () => queueJob(instance.update), instance.scope // track it in component's effect scope
    );
    ...
    if ("development" !== 'production') {
      ...
      effect.onTrigger = instance.rtg ? e => (0, _shared.invokeArrayFns)(instance.rtg, e) : void 0; // @ts-ignore (for scheduler)
  ...
  const updateComponentPreRender = (instance, nextVNode, optimized) => {
    ...
    (0, _reactivity.pauseTracking)(); // props update may have triggered pre-flush watchers.
...
function setupBlock(vnode) {
  ...
  vnode.dynamicChildren = isBlockTreeEnabled > 0 ? currentBlock || _shared.EMPTY_ARR : null; // close block
...
, isBlockNode = false, needFullChildrenNormalization = false) {
  ...
  if (needFullChildrenNormalization) {
    ...
    // string or Array.
    vnode.shapeFlag |= (0, _shared.isString)(children) ? 8
    /* TEXT_CHILDREN */
    : 16
    /* ARRAY_CHILDREN */
    ;
...
function cloneVNode(vnode, extraProps, mergeRef = false) {
  ...
  const cloned = {
    ...
    children: "development" !== 'production' && patchFlag === -1
    /* HOISTED */
    && (0, _shared.isArray)(children) ? children.map(deepCloneVNode) : children,
    target: vnode.target,
...
},{"@vue/runtime-dom":"../node_modules/@vue/runtime-dom/dist/runtime-dom.esm-bundler.js"}],"../node_modules/vue-hot-reload-api/dist/index.js":[function(require,module,exports) {
var Vue // late bind
var version
...
},{}],"components/HeadComponent.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  data: function data() {
    return {
      list: this.onScreenList,
      upload: this.onScreenUpload
    };
  },
  props: {
    onScreenList: Boolean,
    onScreenUpload: Boolean
  },
  methods: {
    onEmit: function onEmit() {
      this.$emit("setInput", this.list, this.upload);
    },
...
=======
        var $97540c = exports.default || module.exports;
      
      if (typeof $97540c === 'function') {
        $97540c = $97540c.options;
      }
    
        /* template */
        Object.assign($97540c, (function () {
>>>>>>> 8441276b2bba49ef2e5b1d9a9855ef013784e9cb
          var render = function () {
  var _vm = this
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _c("nav", [
      _c("ul", { on: { click: _vm.onEmit } }, [
        _c(
          "li",
          {
            on: {
              click: function ($event) {
                ;(_vm.list = true), (_vm.upload = false)
              },
            },
          },
          [_vm._v("물건 리스트")]
        ...
        _c(
          "li",
          {
            on: {
              click: function ($event) {
                ;(_vm.list = false), (_vm.upload = true)
              },
            },
          },
          [_vm._v("물품 올리기")]
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("header", [_c("h1", [_vm._v("🥕 Market")])])
  },
]
...
=======
            api.createRecord('$97540c', $97540c);
          } else {
            api.reload('$97540c', $97540c);
>>>>>>> 8441276b2bba49ef2e5b1d9a9855ef013784e9cb
          }
        }
...
},{"vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm-bundler.js"}],"database.js":[function(require,module,exports) {
"use strict";
...
var database = [{
  ...
  position: "서울시 강남구",
  userName: "마로비",
  image: "https://www.costco.co.kr/medias/sys_master/images/h63/h10/11960561762334.jpg"
}, {
  id: 1,
  title: "강아지 팝니다",
  content: "강아지 자랑하는겁니다~",
  ...
  position: "서울시 송파구",
  userName: "진",
  image: "https://post-phinf.pstatic.net/MjAyMDA5MDFfMTg3/MDAxNTk4OTU0Mjg3ODY1.ScDj1g1gboyqfcQbp6NuBuT0iDBu2Pg_XnMz2UhFAcwg.jOo08-HSOT_iyTw7JE04-qao1J6MNEQbW9f6IQK7emgg.JPEG/1.JPG?type=w1200"
}, {
  id: 2,
  title: "플스 싸게 팔아요",
  content: "쿨거래 바랍니다.",
  ...
  position: "서울시 강동구",
  userName: "마로비",
  image: "https://image.zdnet.co.kr/2019/07/31/khj1981_X612gTAmAdl5.jpg"
}, {
  id: 3,
  title: "스피커 팝니다",
  content: "소리 잘 나오고 아무 문제 없습니다",
  product: "스피커",
  price: 30000,
  position: "경기도 시흥시",
  userName: "RM",
  image: "http://www.bizhankook.com/upload/bk/article/201811/thumb/16577-34532-sample.jpg"
}, {
  id: 4,
  title: "컴퓨터 팔아요!!!",
  content: "사양은 잘 모르겠고 게임 잘 돌아가요!!!",
  product: "컴퓨터",
  price: 800000,
  position: "서울시 양천구",
  userName: "윤기",
  image: "https://foryoucom.co.kr/data/pimg/21/21163_500.jpg"
}, {
  id: 5,
  title: "자가진단키트 팔아요",
  content: "미개봉입니다.",
  ...
  position: "서울시 중랑구",
  userName: "마로비",
  image: "http://www.medigatenews.com/file/news/219010"
}];
var _default = database;
exports.default = _default;
},{}],"components/ProductList.vue":[function(require,module,exports) {
"use strict";
...
=======
        var $b33c86 = exports.default || module.exports;
      
      if (typeof $b33c86 === 'function') {
        $b33c86 = $b33c86.options;
      }
    
        /* template */
        Object.assign($b33c86, (function () {
>>>>>>> 8441276b2bba49ef2e5b1d9a9855ef013784e9cb
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  ...
  return _c("section", [
    _c(
      ...
      _vm._l(_vm.database, function (data, i) {
        return _c("div", { key: i, staticClass: "list" }, [
          _c("div", { staticClass: "image-position" }, [
            _c("img", { attrs: { src: data.image } }),
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "text-position" }, [
            _c("div", { staticClass: "title" }, [_vm._v(_vm._s(data.title))]),
            _vm._v(" "),
            ...
            _c("div", { staticClass: "userName" }, [
              _vm._v("작성자 : " + _vm._s(data.userName) + "님"),
            ]),
          ]),
        ])
      }),
...
=======
            api.createRecord('$b33c86', $b33c86);
          } else {
            api.reload('$b33c86', $b33c86);
>>>>>>> 8441276b2bba49ef2e5b1d9a9855ef013784e9cb
          }
        }
...
},{"../database":"database.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm-bundler.js"}],"components/ProductUpload.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    print: function print(e) {
      ...
      var imgURL = e.target.parentElement.children[0].children[1].files[0];
      ...
      img.src = "";
      var imagePrev = document.querySelector('.imagePrev');
...
=======
        var $342d68 = exports.default || module.exports;
      
      if (typeof $342d68 === 'function') {
        $342d68 = $342d68.options;
      }
    
        /* template */
        Object.assign($342d68, (function () {
>>>>>>> 8441276b2bba49ef2e5b1d9a9855ef013784e9cb
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  ...
  return _c("div", { staticClass: "upload" }, [
    _c("div", { staticClass: "image-upload" }, [
      ...
      _vm._v(" "),
      _c("img", {
        staticClass: "previewBtn",
        attrs: { src: "/preview.db1a6fdb.png" },
        on: { click: _vm.preview },
      }),
      _vm._v(" "),
      _c("img", { staticClass: "previewImg", attrs: { src: "" } }),
    ]),
    _vm._v(" "),
    _vm._m(1),
    _vm._v(" "),
    ...
    _vm._m(5),
    _vm._v(" "),
    _c("button", { staticClass: "uploadBtn", on: { click: _vm.print } }, [
      _vm._v("출력"),
    ]),
  ])
}
var staticRenderFns = [
  function () {
    ...
    return _c("label", { attrs: { for: "file" } }, [
      _c("img", {
        staticClass: "imagePrev",
        attrs: { src: "/picture.fd1bcac9.png" },
      }),
    ])
  },
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "title-upload" }, [
      _c("input", {
        staticClass: "input-title",
        attrs: { type: "text", placeholder: "글 제목" },
      }),
    ])
  },
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "product-upload" }, [
      _c("input", {
        staticClass: "input-product",
        attrs: { type: "text", placeholder: "상품" },
      }),
    ])
  },
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "price-upload" }, [
      _c("input", {
        staticClass: "input-price",
        attrs: { type: "text", placeholder: "￦ 가격" },
      }),
    ])
  },
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "position-upload" }, [
      _c("input", {
        staticClass: "input-position",
        attrs: { type: "text", placeholder: "위치" },
      }),
    ])
  },
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "content-upload" }, [
      _c("textarea", {
        staticClass: "input-content",
        attrs: { placeholder: "내용" },
      }),
    ])
  },
]
...
=======
            api.createRecord('$342d68', $342d68);
          } else {
            api.reload('$342d68', $342d68);
>>>>>>> 8441276b2bba49ef2e5b1d9a9855ef013784e9cb
          }
        }
...
},{"../database":"database.js","./..\\images\\picture.png":[["picture.fd1bcac9.png","images/picture.png"],"images/picture.png"],"./..\\images\\preview.png":[["preview.db1a6fdb.png","images/preview.png"],"images/preview.png"],"vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm-bundler.js"}],"App.vue":[function(require,module,exports) {
"use strict";
...
var _HeadComponent = _interopRequireDefault(require("./components/HeadComponent.vue"));

var _ProductList = _interopRequireDefault(require("./components/ProductList.vue"));

var _ProductUpload = _interopRequireDefault(require("./components/ProductUpload.vue"));
...
var _default = {
  components: {
    HeadComponent: _HeadComponent.default,
    ProductList: _ProductList.default,
    ProductUpload: _ProductUpload.default
  },
  data: function data() {
    return {
      onScreenList: true,
      onScreenUpload: flase
    };
  },
  methods: {
    setInput: function setInput(list, upload) {
      this.onScreenList = list;
      this.onScreenUpload = upload;
      console.log(this.onScreenList);
      console.log(this.onScreenUpload);
    }
  }
};
exports.default = _default;
...
=======
        var $a1d672 = exports.default || module.exports;
      
      if (typeof $a1d672 === 'function') {
        $a1d672 = $a1d672.options;
      }
    
        /* template */
        Object.assign($a1d672, (function () {
>>>>>>> 8441276b2bba49ef2e5b1d9a9855ef013784e9cb
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          attrs: {
            onScreenList: _vm.onScreenList,
            onScreenUpload: _vm.onScreenUpload,
          },
          on: { setInput: _vm.setInput },
        },
        [
          _vm.onScreenList
            ? _c(
                ...
                [
                  _c("button", [_vm._v("확인")]),
                  _vm._v(" "),
                  _vm.onScreenUpload ? _c("ProductUpload") : _vm._e(),
                ],
                1
              )
            : _vm._e(),
...
=======
            api.createRecord('$a1d672', $a1d672);
          } else {
            api.reload('$a1d672', $a1d672);
>>>>>>> 8441276b2bba49ef2e5b1d9a9855ef013784e9cb
          }
        }
...
},{"./components/HeadComponent.vue":"components/HeadComponent.vue","./components/ProductList.vue":"components/ProductList.vue","./components/ProductUpload.vue":"components/ProductUpload.vue","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm-bundler.js"}],"../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"market.css":[function(require,module,exports) {
...
var _market = _interopRequireDefault(require("./market.css"));
...
console.log('CSS', _market.default);
},{"vue":"../node_modules/vue/dist/vue.runtime.esm-bundler.js","./App.vue":"App.vue","./market.css":"market.css"}],"../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
=======
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5451" + '/');
>>>>>>> 8441276b2bba49ef2e5b1d9a9855ef013784e9cb
